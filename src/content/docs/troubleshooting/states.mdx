...
| **Earlier request outcome unknown** | A request timed out and may have applied. Other actions on that asset are locked | No. Select **Check what happened** instead | Checking asks the market and never repeats the action. See [Atomicals](/docs-core/markets/atomicals/#when-a-request-times-out) |
