...
| Manage | Update, Event | `/atomicals/create/manage/update`, `event` |
...
Studio no longer offers it. For a Realm or Subrealm claim, sign the reveal
promptly after the commit confirms.
